...
def serialize(messages, schema, key_names, bookmark_names, max_bytes, max_records):
    ...
    # Use simplejson instead of json here since json can't serialize
    # Python Decimal objects. The record message is deserialized by
    # singer-python's `parse_message` which was changed to parse floats to
